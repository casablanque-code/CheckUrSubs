...
import { getDuplicateGroups, getYearlySavingsCandidates, getFamilyPlanCandidates } from '../lib/insights';
...
const InsightsCard = ({ subscriptions }) => {
  ...
  if (groups.length === 0 && yearly.length === 0 && family.length === 0) return null;
