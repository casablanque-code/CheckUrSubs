...
export const SERVICE_CATALOG = [
  { name: 'Spotify',              aliases: ['спотифай','спотифай','spotify'], domain: 'spotify.com',        category: 'entertainment', serviceType: 'music', familyAvailable: true,
  ...
  { name: 'YouTube Premium',      aliases: ['ютуб','ютуб премиум','youtube'], domain: 'youtube.com',        category: 'entertainment', serviceType: 'video', familyAvailable: true,
    cancelUrl: 'https://www.youtube.com/paid_memberships', cancelSteps: ['Manage membership', 'Cancel membership', 'Confirm'] },
  { name: 'Apple Music',          aliases: ['эпл мьюзик','эпл музик'],        domain: 'apple.com',          category: 'entertainment', serviceType: 'music', familyAvailable: true,
  ...
  { name: 'Amazon Prime',         aliases: ['амазон','амазон прайм'],         domain: 'amazon.com',         category: 'entertainment', serviceType: 'video', yearlyAvailable: true, familyAvailable: true,
  ...
  { name: 'Adobe Creative Cloud', aliases: ['адоб','адобе','adobe'],          domain: 'adobe.com',          category: 'work', yearlyAvailable: true,
    cancelUrl: 'https://account.adobe.com/plans', cancelSteps: ['Plans → Manage plan', 'Cancel plan', 'Confirm — note early cancellation fee'] },
  { name: 'Grammarly',            aliases: ['грамарли'],                      domain: 'grammarly.com',      category: 'work', yearlyAvailable: true,
    cancelUrl: 'https://account.grammarly.com/subscription', cancelSteps: ['Subscription → Cancel', 'Continue to cancel', 'Confirm'] },
  { name: 'Canva',                aliases: ['канва'],                         domain: 'canva.com',          category: 'work', yearlyAvailable: true,
  ...
  { name: 'GitHub Copilot',       aliases: ['гитхаб','github'],               domain: 'github.com',         category: 'work', yearlyAvailable: true,
  ...
  { name: 'Perplexity',           aliases: ['перплексити'],                   domain: 'perplexity.ai',      category: 'work', serviceType: 'ai', yearlyAvailable: true,
  ...
  { name: 'iCloud',               aliases: ['айклауд','icloud'],              domain: 'apple.com',          category: 'internet', serviceType: 'storage', familyAvailable: true,
  ...
  { name: 'Google One',           aliases: ['гугл ван','гугл','google one'],  domain: 'google.com',         category: 'internet', serviceType: 'storage', familyAvailable: true,
  ...
  { name: '1Password',            aliases: ['1пасворд','ванпасворд'],         domain: '1password.com',      category: 'internet', yearlyAvailable: true, familyAvailable: true,
  ...
  { name: 'Duolingo',             aliases: ['дуолинго'],                      domain: 'duolingo.com',       category: 'education', yearlyAvailable: true, familyAvailable: true,
  ...
  { name: 'NordVPN',              aliases: ['норд впн','nordvpn'],            domain: 'nordvpn.com',        category: 'vpn', yearlyAvailable: true,
    cancelUrl: 'https://my.nordaccount.com/dashboard/nordvpn/subscriptions/', cancelSteps: ['Subscriptions → Cancel', 'Confirm cancellation'] },
  { name: 'ExpressVPN',           aliases: ['экспресс впн'],                  domain: 'expressvpn.com',     category: 'vpn', yearlyAvailable: true,
  ...
  { name: 'Яндекс Плюс',         aliases: ['яндекс плюс','яплюс','яндекс'], domain: 'ya.ru',              category: 'entertainment', serviceType: 'music', familyAvailable: true,
